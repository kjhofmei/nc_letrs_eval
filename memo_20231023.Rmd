...
district_school_counts = fread(paste0(workdatadir, 'district_school_counts.csv'))
district_student_counts = fread(paste0(workdatadir, 'district_student_counts.csv'))
...
# prep school counts
district_school_counts_bycohort = district_school_counts[, .(total = sum(school_n, na.rm = TRUE)), by=c('letrs_cohort', 'year', 'category')]
...
# prep student counts
district_student_counts_bycohort = district_student_counts[, .(total = sum(avg_student_num),
